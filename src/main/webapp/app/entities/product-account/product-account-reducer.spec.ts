...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTACCOUNT actions', async () => {
      const expectedActions = [
        {
