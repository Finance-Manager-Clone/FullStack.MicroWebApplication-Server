...
export const AccountDetailsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.accountDetails.delete.question">
        <Translate contentKey="myApp.accountDetails.delete.question" interpolate={{ id: accountDetailsEntity.id }}>
